%% Importando os dados 
% OBS.: estes comandos não funcionaram no MATLAB 2017b, então foi feito
% manualmente as variáveis abaixo:
%data4a = importdata('data_4a.txt');
%data4b = importdata('data_4b.txt');
%data4c = importdata('data_4c.txt');
%data0a = importdata('data_0a.txt');
%data0b = importdata('data_0b.txt');
%data0c = importdata('data_0c.txt');
...
% Agora com 0 pesos
% data_0a
w0a = (diff(data0a(:,5))*(2*pi/16000))/Ts;
% data_0b
w0b = (diff(data0b(:,5))*(2*pi/16000))/Ts;
% data_0c
w0c = (diff(data0c(:,5))*(2*pi/16000))/Ts;
